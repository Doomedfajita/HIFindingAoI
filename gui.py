...
#     #     pass
    ...
    def __init__(self, master):
        ...
        t = threading.Thread(target=start_eye_stream)
        t.start()
        # if currentX > 400:
        #     print("greater")
        # refTime = time.time()
...
root = Tk()
button1 = Button(root, text="Eyetracking", activebackground = 'red', highlightcolor = 'red' , highlightthickness = 10,  width = 32, height = 32, command= lambda : Tracker())
button2 = Button(root, text="Analytics", activebackground = 'blue', highlightcolor = 'red', highlightthickness = 10,  width = 32, height = 32, command= lambda : analytics())
instance1= 0
instance2 = 0
